...
<html>
<head>
    <title>AI Playground - Red Hat & ISO Specialist</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🤖 AI Playground</h1>
            <p>Red Hat Technologies & ISO Standards Specialist - Powered by OpenAI</p>
        </div>
        ...
        <div class="info">
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <div class="info-value">OpenAI</div>
                </div>
                <div class="info-item">
        ...
        <div class="chat-container">
            ...
            <div class="model-selector">
                ...
                <select id="model">
                    ...
                    <option value="gpt-4-turbo" selected>GPT-4 Turbo (Fast & capable)</option>
    ...
    async function sendMessage() {
        ...
        try {
            ...
            if (data.error) {
                ...
                responseDiv.className = 'response-area error';
                responseDiv.innerHTML = '<strong>🚫 Blocked by Guardrails:</strong>\\n\\n' + data.response;
            } else {
